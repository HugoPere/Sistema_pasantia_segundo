  ...
  <li>
    <div>
	  ...
	  <div data-role="main" class="ui-content">
	    <form method="post" action="../api/pasar_lista_back.php" enctype="multipart/form-data">
	      <fieldset data-role="collapsible">
	          <label for="name">¿Cuantos estudiantes hay?:</label>
	          <input type="text" name="asistencia" id="asistencia">
	          <br>
	          <label for="name">Profesor a cargo:</label>
